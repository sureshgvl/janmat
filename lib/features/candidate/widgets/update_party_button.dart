...
class UpdatePartyButton extends StatelessWidget {
  final ChangePartySymbolController controller;
  final GlobalKey<FormState> formKey;

  const UpdatePartyButton({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      final currentSymbolImageUrl =
          foundSymbolMedia != null && foundSymbolMedia.containsKey('url')
          ? foundSymbolMedia['url'] as String
          : '';

      final hasSymbolChanges =
          isIndependent &&
          ...
          onPressed: isEnabled
              ? () async {
                  if (formKey.currentState!.validate()) {
                    final success = await controller.updatePartyAndSymbol(
                      context,
                    );
                    if (success) {
