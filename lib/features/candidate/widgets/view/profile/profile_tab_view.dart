...
class _ProfileTabViewState extends State<ProfileTabView>
  ...
  void _loadLocationDataFromUtils() {
    ...
    final wardNumber = MaharashtraUtils.getWardNumber(widget.candidate.location.wardId ?? '');
    ...
    if (wardNumber != null) {
      ...
      wardDisplayName = widget.candidate.location.wardId ?? ''; // Fallback
    }
      ...
      if (_districtName == null) {
        ...
        final district = districts.firstWhere(
          ...
          orElse: () => District(
            ...
            stateId: widget.candidate.location.stateId ?? 'maharashtra', // Use candidate's actual state ID
          ),
        );
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Education
                if (widget.candidate.basicInfo?.education !=
                    null) ...[
                  Container(
                    padding: const EdgeInsets.all(12),
                    decoration: BoxDecoration(
