...
class CandidateCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selectionController = Get.find<CandidateSelectionController>();
    ...
    return Container(
      ...
      child: Material(
        ...
        child: Obx(() {
          ...
          final isSelected = selectionController.isCandidateSelected(candidate.candidateId);

          return InkWell(
            onTap: () {
              if (isInSelectionMode) {
                selectionController.toggleCandidateSelection(candidate);
              } else {
