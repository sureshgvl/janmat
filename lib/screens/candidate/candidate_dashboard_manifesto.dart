...
class _CandidateDashboardManifestoState extends State<CandidateDashboardManifesto> {
  ...
  final GlobalKey<ManifestoTabEditState> _manifestoSectionKey = GlobalKey<ManifestoTabEditState>();
      ...
      return Scaffold(
        ...
        body: isEditing
            ...
            : ManifestoTabView(
                ...
                isOwnProfile: true,
                showVoterInteractions: false, // Hide voter interactions in dashboard
              ),
