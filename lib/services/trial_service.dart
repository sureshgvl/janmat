...
class TrialService {
  ...
  Future<void> startTrialForCandidate(String userId) async {
    ...
    try {
      ...
      print('✅ Started 3-day trial for candidate: $userId, expires: $trialExpiresAt');
    } catch (e) {
      print('❌ Failed to start trial for candidate: $e');
  ...
  Future<void> endTrial(String userId) async {
    try {
      ...
      print('✅ Ended trial for user: $userId');
    } catch (e) {
      print('❌ Failed to end trial: $e');
  ...
  Future<void> convertTrialToPaid(String userId, {String? planId}) async {
    try {
      ...
      print('✅ Converted trial to paid for user: $userId');
    } catch (e) {
      print('❌ Failed to convert trial to paid: $e');
  ...
  Future<bool> hasExpiredTrial(String userId) async {
    try {
      ...
      print('❌ Error checking expired trial: $e');
      return false;
    }
  }
  ...
  Future<void> cleanupExpiredTrials(String userId) async {
    try {
      ...
      if (hasExpired) {
        ...
        print('🧹 Cleaned up expired trial for user: $userId');
      }
    } catch (e) {
      print('❌ Error cleaning up expired trial: $e');
    }
  }
  ...
  Future<Map<String, int>> getTrialStats() async {
    try {
      ...
      print('❌ Error getting trial stats: $e');
      return {
        'totalTrials': 0,
        'activeTrials': 0,
        'expiredTrials': 0,
